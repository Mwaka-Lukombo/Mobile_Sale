...
export const ProductSinglePage = () => {
  ...
  // Funcao para rederezar estrelas
  ...
  const handleAddToCart = async() => {
    let type = "Product";
    await addCart(idProduct,type,quantity)
  };
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-2 justify-center">
                {product.images.map((img, index) => (
                  <button
                    key={index}
                    className="w-14 h-14 rounded-lg border-2 border-gray-200 hover:border-blue-500 overflow-hidden"
                  >
            ...
            <div className="space-y-5">
              ...
              <div>
                ...
                <div className="flex items-center gap-3">
                  <button
                    ...
                    className="w-10 h-10 rounded-lg border border-gray-300 flex items-center justify-center hover:bg-gray-100 transition-colors text-sm"
                  >
                    -
                  </button>
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 px-4 rounded-xl transition-all transform hover:scale-[1.02] shadow-md text-sm"
              >
              ...
              {/* Benefícios */}
              <div className="pt-2">
                <h2 className="text-base font-semibold text-gray-800 mb-3">Benefícios</h2>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {relatedProducts.map((item) => (
                  ...
                  >
                    ...
                    <p className="text-xs font-medium text-gray-800 group-hover:text-blue-600 transition-colors line-clamp-2">
                      {item?.name}
                    </p>
