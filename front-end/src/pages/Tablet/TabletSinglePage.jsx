              ...
              <div className="p-4 bg-white rounded-xl shadow-sm border border-gray-100">
                ...
                <div className="space-y-2 text-xs">
                  <div className="flex justify-between items-center py-2 border-b border-gray-100">
                    ...
                    <span className="font-medium text-gray-800">{acessorio?.informations?.[0]?.camera || 'N/A'} MP</span>
                  </div>
                  <div className="flex justify-between items-center py-2 border-b border-gray-100">
                    <span className="text-gray-600">RAM:</span>
                    <span className="font-medium text-gray-800">{acessorio?.informations?.[0]?.ram || 'N/A'}</span>
                  </div>
                  <div className="flex justify-between items-center py-2">
                    <span className="text-gray-600">Armazenamento:</span>
                    <span className="font-medium text-gray-800">{acessorio?.informations?.[0]?.gigas || 'N/A'}</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-5">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <button
                    onClick={() => setQuantity(Math.min(acessorio?.stock || 15, quantity + 1))}
                    className="w-10 h-10 rounded-lg border border-gray-300 flex items-center justify-center hover:bg-gray-100 transition-colors font-semibold text-sm"
                  >
                    +
                  </button>
