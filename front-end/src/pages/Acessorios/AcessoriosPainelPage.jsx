...
export const AcessoriosPainelPage = () => {
  ...
  const renderStars = (rating) => {
    ...
    for (let i = 1; i <= 5; i++) {
      if (i <= fullStars) {
        starsArray.push(<Star key={i} size={16} className="fill-yellow-400 text-yellow-400" />);
      } else {
  ...
  const deleteItem = async(id) => {
    if (window.confirm("Tem certeza que deseja deletar este acessório?")) {
    ...
    <div className="w-full min-h-screen bg-gray-50">
      ...
      {showModal && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 p-4 overflow-y-auto">
          ...
          <div className="max-w-2xl w-full mx-auto -my-2">
              ...
              <div className="bg-gradient-to-r from-blue-600 to-blue-700 px-6 py-4 flex justify-between items-center">
                ...
                <div>
                  <h1 className="text-xl font-bold text-white">
                    {!isUpdating ? "Criar novo Acessório" : "Editar Acessório"}
                  </h1>
              ...
              <form onSubmit={!isUpdating ? handleSubmit : handleUpdate} className="p-6">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <input
                      type="text"
                      placeholder="Ex: Headset Bluetooth"
                      value={name}
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="Capas de celular">Capas de celular</option>
                    </select>
                  </div>
                  ...
                  <div>
                    ...
                    <textarea
                      placeholder="Descreva as características do acessório..."
                      rows={4}
                      value={description}
